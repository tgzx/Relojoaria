-- Initial baseline schema for VitrineZap/Relojoaria.
-- Purpose: allow creating a fresh Supabase project/account before applying later incremental migrations.
-- Source: supabase/schema.sql, validated against the current QA Supabase public catalog on 2026-09-12.
-- Data/seed intentionally not included.
